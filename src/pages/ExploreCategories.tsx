    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[var(--background-start)] to-[var(--background-end)] transition-colors duration-300 ease-in-out">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        {!isLoading && !error && visibleCategories.length > 0 && (
          <div
            className="mb-6 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-[var(--text-secondary)]"
            aria-live="polite"
          >
            <span>
              <strong className="text-[var(--text-primary)]">{visibleCategories.length}</strong>{' '}
