...
// Music NFT category cover art (generated mock images).
const musicNft1 = 'https://gtbwpdlebllwrfzgvwfl.supabase.co/storage/v1/object/public/project-assets/5f928b6f-e98b-4b5f-a7ea-25e0082af39e/assets/music-nft-vinyl-glow.png';
const musicNft2 = 'https://gtbwpdlebllwrfzgvwfl.supabase.co/storage/v1/object/public/project-assets/5f928b6f-e98b-4b5f-a7ea-25e0082af39e/assets/music-nft-synth-waves.png';
const musicNft3 = 'https://gtbwpdlebllwrfzgvwfl.supabase.co/storage/v1/object/public/project-assets/5f928b6f-e98b-4b5f-a7ea-25e0082af39e/assets/music-nft-headphones-neon.png';
const musicNft4 = 'https://gtbwpdlebllwrfzgvwfl.supabase.co/storage/v1/object/public/project-assets/5f928b6f-e98b-4b5f-a7ea-25e0082af39e/assets/music-nft-equalizer-aurora.png';
const musicNft5 = 'https://gtbwpdlebllwrfzgvwfl.supabase.co/storage/v1/object/public/project-assets/5f928b6f-e98b-4b5f-a7ea-25e0082af39e/assets/music-nft-cassette-retro.png';
const musicNft6 = 'https://gtbwpdlebllwrfzgvwfl.supabase.co/storage/v1/object/public/project-assets/5f928b6f-e98b-4b5f-a7ea-25e0082af39e/assets/music-nft-concert-stage.png';
...
const allNfts: NFT[] = [
  ...
  // ---- Music NFT category ----
  {
    id: 'music-1',
    imageUrl: musicNft1,
    name: 'Vinyl Dreams #01',
    creator: '0xSoundsmith',
    price: '0.4 KSS',
    description: 'A glowing vinyl record suspended in a sea of light — the debut drop celebrating analog warmth in a digital age.',
    owner: '0xMelodyVault',
    category: 'music',
  },
  {
    ...
    creator: '0xRetroWaver',
    price: '0.65 KSS',
    description: 'Pulsing neon waveforms sweep across a midnight skyline, capturing the heartbeat of a synthwave anthem.',
    owner: '0xNightDrive',
    category: 'music',
  },
  {
    id: 'music-3',
    imageUrl: musicNft3,
    name: 'Headphone Reverie',
    creator: '0xBeatForge',
    price: '0.3 KSS',
    description: 'Floating neon headphones radiate sound rings — an ode to losing yourself in the perfect track.',
    owner: '0xLoopHeads',
    category: 'music',
  },
  {
    id: 'music-4',
    imageUrl: musicNft4,
    name: 'Equalizer Aurora',
    creator: '0xWaveCrafter',
    price: '0.85 KSS',
    description: 'Towering equalizer bars shimmer like an aurora, visualizing a live set in vivid spectral color.',
    owner: '0xSpectrum',
    category: 'music',
  },
  {
    id: 'music-5',
    imageUrl: musicNft5,
    name: 'Cassette Nostalgia',
    creator: '0xTapeDeck',
    price: '0.22 KSS',
    description: 'A retro cassette tape glows against deep magenta — a tribute to mixtapes and the songs that defined an era.',
    owner: '0xMixtape',
    category: 'music',
  },
  {
    id: 'music-6',
    imageUrl: musicNft6,
    name: 'Stage Lights Live',
    creator: '0xLiveWire',
    price: '1.1 KSS',
    description: 'Captured at the climax of a concert, beams of stage light pierce a sea of raised hands and pure energy.',
    owner: '0xFrontRow',
    category: 'music',
  },
];
