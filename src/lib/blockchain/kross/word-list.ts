// src/lib/blockchain/kross/word-list.ts
// Local English word list used to generate human-readable 15-word seed
// phrases. This replaces the `seedWordList` export that is NOT available
// from the esm.sh build of @waves/ts-lib-crypto.
//
// The list is intentionally large (and a power-of-two-friendly size) so that
// modulo selection has minimal bias. Words are lowercase, ASCII, and unique.
export const SEED_WORD_LIST: readonly string[] = [
